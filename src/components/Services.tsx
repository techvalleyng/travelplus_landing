...
export default function Services() {
  return (
    <div id='services'>
      ...
      <div className="hidden md:block text-center capitalize font-inter">
      ...
      <div className="hidden md:flex flex-col md:flex-row justify-evenly items-center">
      ...
      <div className="container-fluid relative py-10 px-4">
        ...
        <div className="flex flex-col md:flex-row flex-wrap mx-auto md:items-center      md:justify-around my-8">
          <div className="flex space-x-5 md:space-x-5 ml-7 md:ml-0  md:flex-col md:text-center w-72 md:m-4 md:flex-1 md:max-w-[200px] sm:max-w-[250px]">
          ...
          <div className="flex space-x-5 md:space-x-5 ml-7 md:ml-0 md:flex-col md:text-center md:m-4 md:flex-1 w-72 md:max-w-[200px] sm:max-w-[250px]">
