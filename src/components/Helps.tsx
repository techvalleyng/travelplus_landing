    ...
    <div id='Contact-us'>
        <div className='Container-fluid mt-6'>
            ...
            <div className="flex mt-10 capitalize gap-20 items-center justify-center">
                <div className="flex  flex-col transition transform duration-300 ease-in-out   items-center border w-[200px] h-[200px] border-gray-100 shadow-lg rounded-lg font-inter hover:-translate-y-4">
                ...
                <div className="flex flex-col font-inter  items-center border w-[200px] h-[200px] border-gray-100 transition transform duration-300 ease-in-out shadow-lg rounded-lg hover:-translate-y-4">
                ...
                <div className="flex flex-col font-inter  items-center border w-[200px] h-[200px] border-gray-100 transition transform duration-300 ease-in-out shadow-lg rounded-lg text-gray-500 hover:-translate-y-4">
