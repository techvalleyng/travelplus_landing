...
export default function Background() {
  ...
  return (
    <>
      <div className="flex flex-col md:flex-row justify-around items-center font-inter">
        <motion.div 
          className='capitalize mt-24 md:mt-20 ml-10 leading-4 text-[#282626]'
      ...
      >
        <form className='flex flex-col md:flex-row justify-center items-center'>
          ...
          <div className="h-16 relative w-full rounded-lg md:rounded-none mb-6 shadow-md border border-l border-gray-100 md:w-80">
            <input
              aria-label='To'
              type="text"
          ...
          <div className="h-16 relative w-full rounded-lg md:rounded-none mb-6 shadow-md border border-l border-gray-100 md:w-40">
            <DatePicker
      ...
      <motion.div 
        className='mb-10 md:mb-20 border border-green-700 mr-10 ml-10 md:ml-28 md:mr-20 md:min-h-72 min-h-32 rounded '
